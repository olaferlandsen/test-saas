...
> ### *SOLUCIÓN:*
> En este caso particular, use Eloquent de Laravel(PHP). Ppoder extender el uso de este modelo es necesario usar el controlador de Laravel o el sistema de Rutas.
